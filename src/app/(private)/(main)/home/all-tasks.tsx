  ...
  return (
    <CenterSection className="flex flex-col gap-2 relative pb-[10rem]">
      <div className="flex flex-col w-full relative">
        <section className="flex justify-between bg-white relative p-4 z-10 dark:border-zinc-600 dark:bg-zinc-800 border border-zinc-100 rounded-md">
              ...
              {Object?.entries(calendar)?.map(([date, tasks]) => {
                ...
                return (
                  <Link
                    ...
                    className="w-6 h-6 bg-zinc-100 data-[selected=false]:opacity-30 transition-all dark:bg-zinc-700 relative group z-10 hover:z-20 rounded-md data-[havetask=true]:bg-indigo-400"
                  >
